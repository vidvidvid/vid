...
import type { MosaicItem } from '@/components/MosaicGallery';
import { Meta } from '@/layouts/Meta';
import { Main } from '@/templates/Main';

const MosaicGallery = dynamic(() => import('@/components/MosaicGallery'), {
  ssr: false,
});

const items: MosaicItem[] = [
  {
    youtubeId: 'UdimcciEJh8',
    description:
